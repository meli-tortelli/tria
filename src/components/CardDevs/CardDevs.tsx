...
export default function CardDevs() {
  return (
    <>
      <section className="flex flex-col w-auto mx-7">
        <article className="flex flex-row justify-between my-8">
        ...
        <article className="flex flex-row-reverse justify-between my-8">
