  ...
  return (
    <>
      <section className="w-1/2 gap-4">
        <h2 className="m-4 text-9xl p-4 font-normal font-serif justify-start break-all">CONTATO</h2>
        <p className="m-4 p-4 sm:text-2xl justify-start font-mono">Estamos disponíveis para trabalhos de frellancer, fale com a gente para criarmos juntos.</p>
      </section>
